...
| [docs/08-runbook.md](docs/08-runbook.md) | **Runbook: пошаговое повторение всего пайплайна** — команды, ссылки на источники данных, карта датасета, снимок состояния |
| [docs/09-dataset-sizing.md](docs/09-dataset-sizing.md) | Как выбираются размеры датасета: статистика оценки, вариативность, метрика FA |
